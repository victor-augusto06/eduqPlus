...
public partial class EduqPlusContext : DbContext {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder) {
        ...
        modelBuilder.Entity<Auditoria>(entity => {
            ...
            entity.HasOne(d => d.Curso).WithMany(p => p.Auditoria)
                .HasForeignKey(d => d.CursoId)
                .HasConstraintName("FK_Auditoria_Curso");

            entity.HasOne(d => d.Auditor).WithMany()
                .HasForeignKey(d => d.AuditorId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("FK_Auditoria_Auditor");
        });
        ...
        modelBuilder.Entity<Avaliacao>(entity => {
            ...
            entity.HasOne(d => d.Curso).WithMany(p => p.Avaliacoes)
                .HasForeignKey(d => d.CursoId)
                .HasConstraintName("FK_Avaliacao_Curso");
        ...
        modelBuilder.Entity<Denuncia>(entity => {
            ...
            entity.HasOne(d => d.Curso).WithMany(p => p.Denuncia)
                .HasForeignKey(d => d.CursoId)
                .HasConstraintName("FK_Denuncia_Curso");
        ...
        modelBuilder.Entity<PromessaCurso>(entity => {
            ...
            entity.HasOne(d => d.Curso).WithMany(p => p.PromessaCursos)
                .HasForeignKey(d => d.CursoId)
                .HasConstraintName("FK_PromessaCurso_Curso");
        });
